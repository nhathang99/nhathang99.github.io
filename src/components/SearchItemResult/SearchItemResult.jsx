      ...
      <S.SortBar>
        ...
        <S.SortBarOptions>
          <S.SortBarOptionsOption
            onClick={() => sortBy('view')}
            className={handleAcitive('view')}
          >
            Phổ Biến
          </S.SortBarOptionsOption>
          <S.SortBarOptionsOption
            onClick={() => sortBy('createdAt')}
            className={handleAcitive('createdAt')}
          >
            Mới Nhất
          </S.SortBarOptionsOption>
          <S.SortBarOptionsOption
            onClick={() => sortBy('sold')}
            className={handleAcitive('sold')}
          >
            Bán chạy
          </S.SortBarOptionsOption>
          <S.SortBarPrice
            onChange={event => sortBy(...event.target.value.split(':'))}
            className={handleAcitive('price')}
        ...
        <S.MiniPageController>
          <S.MiniPageControllerState>
            <S.MiniPageControllerCurrentState className="active">
          ...
          <S.ButtonControllerNext
            onClick={goToNext}
            disabled={
              Number(pagination.page ?? 1) === Number(pagination?.page_size)
            }
          >
            <svg
              viewBox="0 0 7 11"
